...
public class Vokabel {
        ...
        public static void createSamples(){
            allVocabularies.add(new Vokabel("das Haus","La maison","Das ist ein schönes Haus.","C'est une belle maison.","Französisch","Deutsch","Haus & Garten"));
            ...
            allVocabularies.add(new Vokabel("Die Gelegenheit","Lejlighed-en","Du hast nun die Gelegenheit etwas zu tun.","Du har nu leijligheden at gøre noget.","Dänisch","Deutsch","Abstrakte Nomen"));
            allVocabularies.add(new Vokabel("wollen","vouloir","Ich will diesen Film sehen.","Je veux voir ce film.","Französisch","Deutsch","Hilfsverben"));
        }
